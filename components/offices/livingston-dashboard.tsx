// components/livingston-dashboard.tsx
'use client'
...
import { useLivingstonData } from '@/hooks/use-livingston-data'
...
export function LivingstonDashboard() {
  const { tableData, chartData, totalRevenue, transactionCount, loading } = useLivingstonData()
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Livingston Revenue Trend</CardTitle>
          <CardDescription>
          ...
          <div className="flex w-full items-start gap-2 text-sm">
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-2 leading-none text-muted-foreground">
                Livingston office revenue performance
              </div>
            </div>
          </div>
        </CardFooter>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All cleared transactions for Livingston office
          </CardDescription>
        </CardHeader>
        <CardContent>
