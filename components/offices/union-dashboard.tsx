// components/Union-dashboard.tsx
'use client'
...
import { useUnionData } from '@/hooks/use-union-data'
...
export function UnionDashboard() {
  const { tableData, chartData, totalRevenue, transactionCount, loading } = useUnionData()
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Union Revenue Trend</CardTitle>
          <CardDescription>
          ...
          <div className="flex w-full items-start gap-2 text-sm">
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-2 leading-none text-muted-foreground">
                Union office revenue performance
              </div>
            </div>
          </div>
        </CardFooter>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All cleared transactions for Union office
          </CardDescription>
        </CardHeader>
        <CardContent>
