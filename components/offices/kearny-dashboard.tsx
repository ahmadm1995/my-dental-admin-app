// components/kearny-dashboard.tsx
'use client'
...
import { usekearnyData } from '@/hooks/use-kearny-data'
...
export function KearnyDashboard() {
  const { tableData, chartData, totalRevenue, transactionCount, loading } = usekearnyData()
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Kearny Revenue Trend</CardTitle>
          <CardDescription>
          ...
          <div className="flex w-full items-start gap-2 text-sm">
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-2 leading-none text-muted-foreground">
                kearny office revenue performance
              </div>
            </div>
          </div>
        </CardFooter>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All cleared transactions for kearny office
          </CardDescription>
        </CardHeader>
        <CardContent>
