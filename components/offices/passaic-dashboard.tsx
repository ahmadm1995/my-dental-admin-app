// components/Passaic-dashboard.tsx
'use client'
...
import { usePassaicData } from '@/hooks/use-passaic-data'
...
export function PassaicDashboard() {
  const { tableData, chartData, totalRevenue, transactionCount, loading } = usePassaicData()
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Passaic Revenue Trend</CardTitle>
          <CardDescription>
          ...
          <div className="flex w-full items-start gap-2 text-sm">
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-2 leading-none text-muted-foreground">
                Passaic office revenue performance
              </div>
            </div>
          </div>
        </CardFooter>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All cleared transactions for Passaic office
          </CardDescription>
        </CardHeader>
        <CardContent>
