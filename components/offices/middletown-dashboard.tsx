// components/Middletown-dashboard.tsx
'use client'
...
import { useMiddletownData } from '@/hooks/use-middletown-data'
...
export function MiddletownDashboard() {
  const { tableData, chartData, totalRevenue, transactionCount, loading } = useMiddletownData()
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Middletown Revenue Trend</CardTitle>
          <CardDescription>
          ...
          <div className="flex w-full items-start gap-2 text-sm">
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-2 leading-none text-muted-foreground">
                Middletown office revenue performance
              </div>
            </div>
          </div>
        </CardFooter>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All cleared transactions for Middletown office
          </CardDescription>
        </CardHeader>
        <CardContent>
